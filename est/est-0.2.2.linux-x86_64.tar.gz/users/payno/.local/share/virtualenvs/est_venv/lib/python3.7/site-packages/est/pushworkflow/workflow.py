...
def exec_process(callback_info, input_, properties):
    print('processing', str(callback_info), 'with input', input_, 'and',
...
class ActorFactory(object):
    ...
    def connect(self, actor):
        print('link', actor, 'to', self.listDownStreamActor)
    ...
    def triggerDownStreamActor(self, inData=None):
        print('in triggerDownStreamActor')
        if inData is None:
            inData = {}
